...
import { OpenStreetMapProvider } from 'leaflet-geosearch'; // For address search
...
const MapRouting = () => {
  ...
  const provider = new OpenStreetMapProvider(); // OSM geosearch provider
  ...
  const handleCheckComplaints = () => fetchComplaints();
  const handleCheckPotholes = () => fetchPotholes();
      ...
      <div className="address-inputs" style={{ marginBottom: '10px' }}>
        <div>
          ...
          <input
            ...
            onBlur={() => handleAddressSearch(sourceAddress, setSourceCoords)} // Search on input blur
        ...
        <div>
          ...
          <input
            ...
            onBlur={() => handleAddressSearch(destinationAddress, setDestinationCoords)} // Search on input blur
